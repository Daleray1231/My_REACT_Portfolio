      ...
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-8 leading-relaxed text-white">
            I am an Independent Freelance Web Application Developer. My expertise lies in Front End Web Development and Features, specializing in Online Marketing through Website Design, Search Engine Optimization (SEO), and Social Media Marketing.
          </p>
